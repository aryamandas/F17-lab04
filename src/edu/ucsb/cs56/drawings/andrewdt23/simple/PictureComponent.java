package edu.ucsb.cs56.drawings.andrewdt23.simple;
...
/**
   A component that draws a Picture by Andrew Thompson
   
   @author Phill Conrad (original drawing)
   @author @@@ Andrew Thompson (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Winter Wonderland, Andrew Thompson", 20,20);
