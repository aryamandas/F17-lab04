package edu.ucsb.cs56.drawings.rjnares.simple;
...
/**
   ...
   @author Roberto J. Nares (fixed the snowmans's head)
...
{  
	...
	final double bottomRadius = 20;
        ...
        Circle snowManBottomCircle = new Circle(snowManCenterBottomX, snowManCenterBottomY - bottomRadius, bottomRadius);
        g2.draw(snowManBottomCircle);
	
        Circle snowManMiddleCircle = new Circle(snowManCenterBottomX, snowManCenterBottomY - bottomRadius * 2 - middleRadius, middleRadius);
	...
	g2.drawString("HOUSE & SNOWMAN by Roberto J. Nares", 20,20);
    }
}
