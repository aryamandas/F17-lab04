...
public class AllMyDrawings
{
    ...
    public static void drawPicture1(Graphics2D g2) {
        ...
        // draw a red tree that is a scaled and translated 
        // copy of t1
        ...
        // draw a green tree that is a scaled,
        // translated, and rotated copy of t1

        Shape t3 = ShapeTransforms.scaledCopyOf(t1,3,2.5);
        t3 = ShapeTransforms.translatedCopyOf(t3, 0, 80);
    ...
    public static void drawPicture2(Graphics2D g2) {
        ...
        // draw a black Christmas tree

	   ChristmasTree c1 = new ChristmasTree(50,50,150,150);
       g2.setColor(Color.BLACK);
       g2.draw(c1);

       // draw a red Christmas tree that is a scaled
       // and translated copy of c1
       ...
       // draw a green Christmas tree that is a scaled,
       // translated, and rotated copy of c1
    ...
    /**
     * Draw a picture with a few regular trees and a
     * few Christmas trees
     */
    ...
    public static void drawPicture3(Graphics2D g2) {
       ...
       // draw a red tree that is a scaled, translated,
       // and rotated copy of t1
       ...
       // draw a green tree that is a scaled, translated,
       // and rotated copy of t1
