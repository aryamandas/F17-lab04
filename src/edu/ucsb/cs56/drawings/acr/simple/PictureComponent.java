package edu.ucsb.cs56.drawings.acr.simple;
...
/**
   A component that draws a Picture by Phill Conrad, edited by Arielle Robles
   
   @author Phill Conrad (original drawing)
   @author Arielle Robles (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Arielle Robles's Updated Snowman", 20,20);
