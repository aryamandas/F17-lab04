package edu.ucsb.cs56.drawings.dstoyanova.simple;
...
/**
   ...
   @author Deni Stoyanova (fixed the snowmans's head)
...
{  
    ...
    {  
        ...
        g2.drawString("Deni Stoyanova - Snowman has a head", 20,20);
