package edu.ucsb.cs56.drawings.labasan.simple;
...
/**
   ...
   @author Kai Labasan (fixed the snowmans's head)
...
{  
    ...
    {  
        ...
        final double bottomRadius = 30;
        final double middleRadius = 60;
        final double topRadius = 100;
        final double snowManCenterBottomX = 400;
        final double snowManCenterBottomY = 250;
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Issa SnowMan - Kai Labasan", 20,20);
